{
    ...
    "version": "17.0.1.0.0",
    "depends": ["web","sale_management","portal","sign"],
    "data": [
    ...
    'assets': {
         'web.assets_frontend': [
              ('replace', 'portal/static/src/signature_form/signature_form.js', 'portal_view_customization/static/src/terms_check/terms_check.js'),
